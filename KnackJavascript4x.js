...
(function() {
  ...
  function initializeFlashcardApp() {
    ...
    var container = document.querySelector('#view_3005 .kn-rich-text'); // Target specific view's rich text
    ...
    if (!container) {
        console.error("Flashcard app: Could not find container element ('#view_3005 .kn-rich-text'). Cannot create iframe.");
  ...
  $(document).ready(function() {
    ...
    // --- Added: Delay initialization slightly to help ensure iframe exists ---
    setTimeout(initializeFlashcardApp, 100); // Delay by 100ms
    // --- End Added Delay ---
  });
